class Config():
    ...
    membersStyleSheet = 'QPushButton{color:#C3C4D1;font-size:15px;padding:10px;border:none;text-align: left;}QPushButton:hover{color: white;}QPushButton:after{content:\'texttext\'}'
